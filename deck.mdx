...
<DefinitionLayout num={7} title="Échelle d'abstraction" translation="Abstraction gradient">
...
Possibilité de revenir en arrière, de conserver les états antérieurs
